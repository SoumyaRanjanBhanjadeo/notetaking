...
const Createnote = () => {
  ...
  return (
    <div id='Createnote'>
      <GrClose alt="close" id='closeNoteIcon' onClick={() => { navigate("/") }} />
      <div id='CreateNotecard'>
        <div id='CreateNotecardHead'>
          <div id='CreatenoteContent'>
            <input type="text" name="title" id="CreatenoteTitle" onChange={(e) => { handleNoteChange(e) }} placeholder='Title' autoFocus/>
